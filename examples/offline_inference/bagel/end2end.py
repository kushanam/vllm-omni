...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a composable-parallel strategy.yaml (opt-in). Its derived parallel "
        "sizing (e.g. sp_ulysses -> ulysses_degree) is overlaid onto the registry-merged "
        "DiT stage before per-stage engine args are built.",
    )
...
def main():
    ...
    if args.strategy_config:
        omni_kwargs["strategy_config"] = args.strategy_config
